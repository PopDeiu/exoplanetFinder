...
from exoplanetFinder.utils.database import get_connection
...
def get_saved_stars():
    ...
    conn = get_connection()
    if not conn:
        return {"eroare_critica": "API-ul NU se poate conecta la MySQL! Verifică parola, userul sau dacă serverul e pornit."}
